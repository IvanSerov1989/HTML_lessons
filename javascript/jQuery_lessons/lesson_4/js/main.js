...
//$('a:eq(2)').css('border', '1px solid red'); // Элемент под номером ... (нуменрация с 0)
//$('*:not(h2,p)').css('border', '1px solid red'); // Исключает из найденых элементов selector
...
//$('li:animated').css('border', '1px solid red'); // Только те элементы, которые задействованны в анимации
